...
describe Biblio do
    ...
    describe "Comprobación de un correcto funcionamiento de los métodos" do
        ...
        it "Test método fecha" do
            expect(@b1.fecha_publicacion).to eq("fecha publicacion")
            expect(@b2.fecha_publicacion).to eq("fecha publicacion")
            expect(@b3.fecha_publicacion).to eq("fecha publicacion")
        end
